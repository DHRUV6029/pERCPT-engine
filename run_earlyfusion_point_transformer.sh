...
#additional add to create symbolic link betweent
export LD_LIBRARY_PATH="/home/wencen/anaconda3/pkgs/cudatoolkit-11.0.221-h6bb024c_0/lib/:$LD_LIBRARY_PATH"
...
BATCHSIZE=16
RUN=cool-fire-4
CHECKPOINT=/home/wencen/Documents/Coopernaut/ckpts/model-74.th   #replace it with local path
BETA=0.8
CONFIG=benchmark/scene${SCEN}.json
CARLA_WORKERS=1
WORKERS=16
